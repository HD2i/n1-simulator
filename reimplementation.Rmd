...
n1_simulate <- function(
  ...
  if(return_data_frame) {
    ...
    do.call(data.frame, c(
      ...
      setNames(
        lapply(1:n_treatments, function(i) treatment_mat_t_obs_binary[,i]),
        sapply(1:n_treatments, function(i) sprintf("treatment_%d", i))
      ),
      list(
        effect = effect_vec
      ),
      setNames(
        lapply(1:n_treatments, function(i) effect_mat[,i]),
        sapply(1:n_treatments, function(i) sprintf("effect_%d", i))
      ),
      list(
        outcome = outcome_vec,
